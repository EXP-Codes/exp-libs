...
public final class Base64 {
    ...
    private final static int     BASELENGTH           = 128;
    ...
    private final static boolean fDebug               = false;
    private final static byte[]  base64Alphabet       = new byte[BASELENGTH];
    private final static char[]  lookUpBase64Alphabet = new char[LOOKUPLENGTH];

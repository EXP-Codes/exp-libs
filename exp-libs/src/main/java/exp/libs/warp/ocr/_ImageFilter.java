...
final class _ImageFilter {
	...
	/** 图像二值化 */
	protected BufferedImage changeGrey() {
	...
	/** 提升清晰度,进行锐化 */
	protected BufferedImage sharp() {
		PixelGrabber pg = new PixelGrabber(image.getSource(), 
	...
	/** 中值滤波 */
	protected BufferedImage median() {
		PixelGrabber pg = new PixelGrabber(image.getSource(), 
				0, 0, iw, ih, pixels, 0, iw);
	...
	/** 线性灰度变换 */
	protected BufferedImage lineGrey() {
		PixelGrabber pg = new PixelGrabber(image.getSource(), 
				0, 0, iw, ih, pixels, 0, iw);
	...
	/** 转换为黑白灰度图 */
	protected BufferedImage grayFilter() {
	...
	/** 平滑缩放 */
	protected BufferedImage scaling(double s) {
	...
	protected BufferedImage scale(Float s) {
